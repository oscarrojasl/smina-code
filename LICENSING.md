...
| `LICENSE.GNU` → `LICENSE` | Renamed to the conventional filename so the references in this file and `README.md` resolve; the GPLv2 text is unchanged |
| `README` → `README.md` | Converted to Markdown; content unchanged apart from formatting |
