...
# Modified 2026 by Oscar Rojas (smina modernized-build fork): added Homebrew
# search paths.  See LICENSING.md.
...
if(OPENBABEL3_INCLUDE_DIR AND OPENBABEL3_LIBRARIES)
  ...
  if(NOT OPENBABEL3_INCLUDE_DIR)
      find_path(OPENBABEL3_INCLUDE_DIR openbabel/obconversion.h
        ...
        ~/include/openbabel3
        ~/include
        $ENV{HOMEBREW_PREFIX}/include/openbabel3
        /opt/homebrew/include/openbabel3
        /opt/homebrew/opt/open-babel/include/openbabel3
      )
  ...
  find_library(OPENBABEL3_LIBRARIES NAMES openbabel openbabel3
      ...
      /opt/homebrew/lib
      /opt/homebrew/opt/open-babel/lib
      $ENV{LD_LIBRARY_PATH}
    )
